...
AnalysisResult _$AnalysisResultFromJson(
  ...
  analysisType: AnalysisResult._analysisTypeFromJson(
    json['analysisType'] as String,
  ),
  analysisMode: json['analysisMode'] == null
      ? AnalysisMode.staticCode
      : AnalysisResult._analysisModeFromJson(json['analysisMode'] as String?),
  ...
  monitoringRecommendations:
      (json['monitoringRecommendations'] as List<dynamic>?)
          ?.map(
            (e) => MonitoringRecommendation.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
